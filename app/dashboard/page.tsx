      ...
      <div className="w-full py-4 grid grid-cols-3 gap-3">
        <div className="bg-zinc-100 rounded-lg">
          <div className="w-full flex gap-4 py-4 px-6 bg-zinc-900 rounded-t-lg">
            <div>
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/c7d72d02b409f925626f0d12e0c8f30fae2362b4?placeholderIfAbsent=true"
              />
            </div>
            <div>
          ...
          <div className="px-8 mb-5">
            <Link href="/dashboard/kelas-saya" className="text-zinc-600 hover:text-zinc-900 text-sm font-medium">Lihat Daftar Kelas</Link>
          </div>
        </div>
        <div className="bg-zinc-100 rounded-lg">
          <div className="w-full flex gap-4 py-4 px-6 bg-zinc-900 rounded-t-lg">
            <div>
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/4b5c2c4295242f6c85d7dc82bc0d73851f0c17e7?placeholderIfAbsent=true"
              />
            </div>
            <div>
        ...
        <div className="bg-zinc-100 rounded-lg">
          <div className="w-full flex gap-4 py-4 px-6 bg-zinc-900 rounded-t-lg">
            <div>
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/d99fb28c92070636c094d2b77891bc3da48b962a?placeholderIfAbsent=true"
              />
            </div>
            <div>
          ...
          <div className="px-8 mb-5">
            <Link href="/dashboard/sertifikasi" className="text-zinc-600 hover:text-zinc-900 text-sm font-medium">Lihat Daftar Sertifikasi</Link>
          </div>
        </div>
      </div>
        ...
        <div className="w-[35%] max-md:w-full max-md:ml-0 space-y-4">
          ...
          >
            <div className="bg-[rgba(51,51,51,1)] flex gap-5 overflow-hidden justify-between pl-5 pr-[62px] pt-[21px] pb-[110px] rounded-md max-md:pr-5 max-md:pb-[100px]">
              ...
              <img
                src="https://api.builder.io/api/v1/image/assets/TEMP/f06f2f3cdc3fc5ddb37d425eaaa4b5eda9219eee?placeholderIfAbsent=true"
            ...
            <div className="flex flex-col">
              ...
              >
                ...
                <div className="flex flex-col items-stretch text-sm text-left">
                  <div className="text-black">Ketentuan Umum Perpajakan KUP A</div>
                  <div className="text-[rgba(131,131,131,1)] mt-[11px]">09.00 - 12.15</div>
                </div>
              </Link>
              <Link
                href="/dashboard/kelas-saya"
