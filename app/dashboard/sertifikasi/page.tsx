...
export default function SertifikasiPage() {
  return (
    <div className="flex-1" data-testid="sertifikasi-page">
      <div className="mb-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="flex flex-wrap gap-1">
                <Badge variant="outline" className="text-xs border-zinc-300">React</Badge>
                <Badge variant="outline" className="text-xs border-zinc-300">JavaScript</Badge>
                <Badge variant="outline" className="text-xs border-zinc-300">Intermediate</Badge>
                <Badge variant="outline" className="text-xs border-zinc-300">Redux</Badge>
              </div>
            </div>
            <div className="pt-4 border-t border-zinc-300">
              <div className="flex items-center justify-between mb-4">
                <span className="text-lg font-bold text-primary">Rp 2.500.000</span>
              </div>
              <Button className="w-full bg-zinc-900 text-white">Daftar Sekarang</Button>
            </div>
          </div>
        </Card>
        <Card className="hover:shadow-lg transition-shadow  border border-zinc-300 py-4 px-6 rounded-lg space-y-4">
