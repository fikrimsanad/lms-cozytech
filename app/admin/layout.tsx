        ...
        <nav className="flex flex-col h-full">
          ...
          <div className="flex-1 px-3 space-y-1">
            {adminMenuItems.map((item) => {
              ...
              return (
                <Link key={item.href} href={item.href} className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${isActive ? "bg-gray-900 text-white" : "text-gray-600 hover:bg-gray-100 hover:text-gray-900"}`} data-testid={`admin-nav-${item.label.toLowerCase()}`}>
          ...
          <div className="px-3 pb-6 space-y-1">
            <Link href="/login" className="flex items-center gap-3 w-full px-4 py-3 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50 transition-colors" data-testid="admin-logout-button">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2 bg-gray-50 px-3 py-1.5 rounded-lg">
                ...
                <span className="text-sm font-medium text-gray-700" data-testid="admin-header-name">Admin</span>
              </div>
